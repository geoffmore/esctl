...
var watcherGet = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherGet(client, args[0])
		if err != nil {
			log.Fatal(err)
		}
	},
...
var watcherDelete = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherDelete(client, args[0])
		if err != nil {
			log.Fatal(err)
		}
	},
...
var watcherExecute = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherExecute(client, args[0])
		if err != nil {
			log.Fatal(err)
		}
	},
...
var watcherGetStats = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherGetStats(client)
		if err != nil {
			log.Fatal(err)
		}
	},
...
var watcherAck = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherAck(client, args[0])
		if err != nil {
			log.Fatal(err)
		}
	},
...
var watcherActivate = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherActivate(client, args[0])
		if err != nil {
			log.Fatal(err)
		}
	},
...
var watcherDeactivate = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherDeactivate(client, args[0])
		if err != nil {
			log.Fatal(err)
		}
	},
...
var watcherShowActive = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherShowActive(client)
		if err != nil {
			log.Fatal(err)
		}
	},
...
var watcherShowInactive = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = escmd.WatcherShowInactive(client)
		if err != nil {
			log.Fatal(err)
		}
	},
